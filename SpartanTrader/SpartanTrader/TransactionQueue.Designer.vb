...
Partial Public NotInheritable Class TransactionQueue
    ...
    Private Sub InitializeControls()
        Me.TransactionQueueLO = Globals.Factory.CreateListObject(Nothing, Nothing, "Sheet5:TransactionQueueLO", "TransactionQueueLO", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _TransactionQueue As TransactionQueue
    
    Friend Shared Property TransactionQueue() As TransactionQueue
        Get
            Return _TransactionQueue
        End Get
        Set
            If (_TransactionQueue Is Nothing) Then
