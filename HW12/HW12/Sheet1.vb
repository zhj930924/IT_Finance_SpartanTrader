...
Public Class Sheet1
    ...
    Private Sub FormatAsAPivotBtn_Click(sender As Object, e As EventArgs) Handles FormatAsAPivotBtn.Click
        ...
        myPivotTable.PivotFields("Month").Orientation = Excel.XlPivotFieldOrientation.xlRowField
        myPivotTable.PivotFields("Budget").Orientation = Excel.XlPivotFieldOrientation.xlDataField
        myPivotTable.PivotFields("Category").Orientation = Excel.XlPivotFieldOrientation.xlRowField
        myPivotTable.PivotFields("Item").Orientation = Excel.XlPivotFieldOrientation.xlRowField
        ...
        'Change the captions
        myPivotTable.PivotFields("Sum of Budget").Caption = " Budget"
